...
public class StorePage extends BasePage{
    ...
    public void clickOnCartIcon() {
        ...
        WebElement visibleCartIcon = wait.until(ExpectedConditions.presenceOfElementLocated(cartIcon));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", visibleCartIcon);
        wait.until(ExpectedConditions.elementToBeClickable(visibleCartIcon)).click();
    }
}
